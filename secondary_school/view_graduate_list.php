...
if (!$con->query("DESCRIBE `graduates`")){
  echo "<div>Graduates list does not exist</div>";
  exit;
}
  $result=$con->query("SELECT * FROM `graduates`
                      ORDER BY `ssession_graduated` ");
  ...
  if ($result->num_rows > 0) {
    ...
    echo "<h2 align='center'>Showing List of Students</h2><p>
          <div style='margin-bottom:30px;'>
            <div>Class: <b style='color:red;'>Graduates</b></div>
