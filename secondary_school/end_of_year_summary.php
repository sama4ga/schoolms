...
<table id="headerTable">
  ...
  <tr>
    <td style="vertical-align:top;border-right:2px solid black;">
      <table class="table-bordered">

        <tr>
          <!-- <th rowspan="2">S/N</th> -->
          <th colspan="7">Credit</th>
        </tr>
        <tr>    
        ...
        if (!empty($sales_date)) {
          for ($i=0; $i < count($sales_date); $i++) { 
            ...
            echo "<tr>
                    ...
                    <td>".number_format($sales_price[$i])."</td>
                    <td>".number_format($sales_amount_paid[$i])."</td>
                    
                  </tr>";
                  /* <td>".number_format($sales_balance[$i])."</td>  */
          }     
        }else {
          $sales_amount_paid = [0];
        }
  ...
  ?>
        ...
        <tr>
          ...
          <td></td>
          <td></td>
          <td><b><?php echo number_format(array_sum($sales_amount_paid)); ?></b></td>
          <td></td>
        </tr>
      </table>
    </td>
        ...
        if (!empty($expenses_date)) {
          for ($i=0; $i < count($expenses_date); $i++) { 
            ...
            echo "<tr>
                    ...
                    <td>".number_format($expenses_quantity[$i])."</td>
                    <td>".number_format($expenses_price[$i])."</td>
                    <td>".number_format($expenses_amount_paid[$i])."</td>
                    <td>".number_format($expenses_balance[$i])."</td>
                  </tr>";

          }     
        }else {
          $expenses_amount_paid = [0];
        }
  ...
  ?>
        ...
        <tr>
          ...
          <td></td>
          <td></td>
          <td><b><?php echo number_format(array_sum($expenses_amount_paid)); ?></b></td>
          <td></td>
        </tr>
      </table>
    </td>
  ...
  <tr>
    <td><b>Net Profit = <span style="text-decoration:line-through double;">N</span><?php $profit = array_sum($sales_amount_paid) - array_sum($expenses_amount_paid); echo number_format($profit); ?></b></td>
    <td></td>
  </tr>
